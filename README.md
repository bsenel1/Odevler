# MSSQL Audit Pipeline

## Overview

MSSQL Audit Pipeline is a Rust-based audit collection service that reads Microsoft SQL Server audit files (`.sqlaudit`) through a central MSSQL instance and stores the parsed audit records in PostgreSQL.
